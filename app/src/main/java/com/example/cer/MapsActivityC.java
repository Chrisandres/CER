...
import com.example.cer.mapsdirection.FetchURL;
import com.example.cer.mapsdirection.TaskLoadedCallback;
...
public class MapsActivityC extends AppCompatActivity implements OnMapReadyCallback, TaskLoadedCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        place1 = new MarkerOptions().position(new LatLng(-33.4233405,-70.5896287)).title("Las Condes");
        place2 = new MarkerOptions().position(new LatLng(-33.5954955,-70.5968088)).title("Puente Alto");
